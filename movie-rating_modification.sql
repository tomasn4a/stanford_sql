...
-- Q3
-- For all movies that have an average rating of 4 stars or higher, add 25 to the release 
...
-- Q4
-- Remove all ratings where the movie's year is before 1970 or after 2000, and the rating 
